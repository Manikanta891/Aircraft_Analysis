# ThiS was original collission detection code, but it was too slow 
# collision_detection-2 code is a much faster version that uses a more efficient runway-based approach
...
VIDEO_PATH = ROOT_DIR / "Simulation_Videos" / "runway_simulation.mp4"
...
print("\n" + "=" * 60)
print("RUNWAY-BASED COLLISION DETECTION COMPLETE")
print("=" * 60)
print(f"Total frames processed: {frame_count}")
print(f"Total collision warnings: {collision_warnings}")
print(f"Runways configured: {len(runways)}")
